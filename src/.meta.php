...
namespace Illuminate\Database\Schema {
     ...
     * @method Fluent dropWatchInsert()
     * @method Fluent dropWatchUpdate()
     * @method Fluent dropWatchDelete()
     * @method Fluent disallowDelete()
     * @method Fluent allowDelete()
     * @method void addWatchColumns(bool $areUserColumnsRequired = true)
     * @method void dropWatchColumns()
     * @method void addSoftDeleteColumns()
     * @method void dropSoftDeleteColumns()
